...
import 'package:app_loja_virtual/screens/checkout/components/card_back.dart';
import 'package:app_loja_virtual/screens/checkout/components/card_front.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            FlatButton(
              ...
              child: const Text('Virar o cartao'),
            )
          ],
        ),
      ),
