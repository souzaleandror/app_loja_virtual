class CepAbertoAddress {
  ...
  @override
  String toString() {
    return 'CepAbertoAddress{altitude: $altitude, cep: $cep, latitude: $latitude, longitude: $longitude, logradouro: $logradouro, bairro: $bairro, complemento: $complemento, cidade: $cidade, estado: $estado}';
  }
}
